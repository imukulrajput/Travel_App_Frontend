...
const FilterProvider = ({children}) =>{
    ...
    return <FilterContext.Provider value={{isFilterModalOpen,priceRange,noOfBathrooms,noOfBedrooms,noOfBeds,propertyType,traveloRating,isCancelable,filterDispatch}}>
      {children}
