import "./Filter.css";
import { FreeCancel, PriceRange, PropertyType, Ratings } from "./index";
import { RoomsAndBeds } from "./index";
        ...
        <div className="filter-modal">
            <div className="filter-page shadow">
                 <div className="d-flex align-center justify-space-between">
                     ...
                     <button className="button btn-filter-close cursor-pointer d-flex align-center justify-center" onClick={handleFilterModalClose}>
